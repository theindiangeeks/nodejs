alert("Click on UPLOAD to upload Your Picture ")
var timerFunction;
...
var imagePuzzle = {
    ...
    setImage: function (images, gridSize = 4) {
        ...
        for (var i = 0; i < gridSize * gridSize; i++) {
            ...
            li.style.width = 1059 / gridSize + 'px';
            li.style.height = 1059 / gridSize + 'px';
            ...
            li.ondrop = (event) => {
                ...
                if (origin && dest && p) {
                    ...
                    if (isSorted(vals)) {
                        ...
                        document.querySelectorAll("#playPanel")[0].style.backgroundColor = "red"
                        helper.doc('actualImageBox').innerHTML = helper.doc('gameOver').innerHTML;
                        alert(`Message From Sahil \n YOU Won Click on "OK" to Get the result \n Try Changing The Picture \n  You Can Try Medium And Hard Level 
